...
module.exports = (() => {
    const config = { "main": "index.js", "info": { "name": "seyforStereo", "authors": [{ "name": "seyfor", "discord_id": "779066123374428171" }], "version": "0.0.1", "description": "Stereo plugin" }, "changelog": [{ "title": "Changes", "items": ["Fixe"] }], "defaultConfig": [{ "type": "switch", "id": "enableToasts", "name": "Enable Toasts", "note": "Allows the plugin to warn you about voice settings", "value": true }] };
    ...
    return !global.ZeresPluginLibrary ? class {
        ...
        const plugin = (Plugin, Library) => {
            ...
            return class seyforStereo extends Plugin {
                onStart() {
                    this.settingsWarning();
                    const voiceModule = WebpackModules.getModule(BdApi.Webpack.Filters.byPrototypeFields("updateVideoQuality"));
                    BdApi.Patcher.after("seyforStereo", voiceModule.prototype, "updateVideoQuality", (thisObj, _args, ret) => {
                        if (thisObj) {
                            ...
                            thisObj.conn.setTransportOptions = function(obj) {
                                if (obj.audioEncoder) {
                                    ...
                                    obj.audioEncoder.channels = 5;
                                }
                                if (obj.fec) {
                                    obj.fec = false;
                                }
                                if (obj.encodingVoiceBitRate < 815100) { //160
                                    obj.encodingVoiceBitRate = 815100
                                }
                ...
                settingsWarning() {
                    ...
                    if (
                        ...
                        if (this.settings.enableToasts) {
                            Toasts.show(
                                "Please disable echo cancellation, noise reduction, and noise suppression for yayaStereo", { type: "warning", timeout: 8000 }
                            );
                        }
